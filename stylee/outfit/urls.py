...
urlpatterns = [
    ...
    url(r'^update/$', OutfitEditAPIView.as_view(), name="edit_outfit"),
    ...
    url(r'^outfitsbycategory/(?P<category_id>\d+)/$', OutfitListByCategoryId.as_view(), name="outfit_categories"),
    ...
    url(r'^next/(?P<user_id>\d+)/$', ProfileOutfitListNext.as_view(), name="outfit_list_next"),
